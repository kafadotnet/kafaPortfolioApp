...
// import { resume } from "../assets/docs/fabrice-karenzi-cv.pdf"
        ...
        <div className="profile-content row align-items-center">
          <div className="profile-description col-12 col-md-6">
            ...
            <div className="profile-descr--buttons">
              <Link to="/contact-me" className="btn-get-in-touch">Get in Touch</Link>
              <a href="fabrice-karenzi-cv.pdf" download="fabrice-karenzi-cv.pdf" className="btn-resume">
